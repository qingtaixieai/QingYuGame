...
install -d /opt/qingyu/releases/resources-v2
 tar -xzf /home/ubuntu/qingyu-resources-v2.tar.gz -C /opt/qingyu/releases/resources-v2
install -m 644 /opt/qingyu/releases/resources-v2/game.jar /opt/qingyu/game.jar
...
cp -r /opt/qingyu/releases/resources-v2/frontend/assets/. /opt/qingyu/frontend/assets/
cp /opt/qingyu/releases/resources-v2/frontend/index.html /opt/qingyu/frontend/index.html.next
